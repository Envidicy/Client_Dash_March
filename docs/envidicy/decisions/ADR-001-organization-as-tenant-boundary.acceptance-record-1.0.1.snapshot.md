...
amendment_review_target_document_version: 1.0.1-rc.1
amendment_review_target_full_file_sha256: 0c716c985915ace13492f0e4bd2ad7153fb391168249eedea399b485c668a679
amendment_approval_evidence_ref: ./ADR-001-organization-as-tenant-boundary.acceptance-record-amendment-001.md#approval-attestation-denis-2026-07-23
amendment_accepted_at: 2026-07-23
...
> Редакционная поправка `ADR-001-AR-A001` применена после прямого `APPROVE` Architecture Owner для полного SHA-256 review target `0c716c985915ace13492f0e4bd2ad7153fb391168249eedea399b485c668a679`. Действующая редакция Acceptance Record — `1.0.1`; редакция `1.0.0` сохранена неизменяемым снимком.
...
semantic_impact: NONE
evidence_ref: ./ADR-001-organization-as-tenant-boundary.acceptance-record-amendment-001.md#approval-attestation-denis-2026-07-23
```
