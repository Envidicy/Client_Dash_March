...
Текущий статус — `REVIEW`: formal human review открыт для точного snapshot, но reviewer decisions ещё не зафиксированы. Решение остаётся `PROPOSED`; `ACCEPTED` не установлен.
