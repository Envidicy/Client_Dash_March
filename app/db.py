...
def apply_schema():
    if _is_postgres(DB_URL):
        ...
        with get_conn() as conn:
            ...
            conn.execute("ALTER TABLE topups ADD COLUMN IF NOT EXISTS meta_cap_before BIGINT")
            conn.execute("ALTER TABLE topups ADD COLUMN IF NOT EXISTS meta_cap_target BIGINT")
            conn.execute("ALTER TABLE topups ADD COLUMN IF NOT EXISTS meta_cap_confirmed BIGINT")
            conn.execute("ALTER TABLE topups ADD COLUMN IF NOT EXISTS meta_cap_error TEXT")
            conn.execute("ALTER TABLE topups ADD COLUMN IF NOT EXISTS meta_cap_attempted_at TIMESTAMPTZ")
            conn.execute("ALTER TABLE topups ADD COLUMN IF NOT EXISTS meta_cap_applied_at TIMESTAMPTZ")
            conn.execute("ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS source_type TEXT")
            conn.execute("ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS source_id BIGINT")
            conn.execute("ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS source_key TEXT")
            conn.execute("CREATE UNIQUE INDEX IF NOT EXISTS idx_wallet_transactions_source_key ON wallet_transactions(source_key)")
            ...
            conn.execute("ALTER TABLE user_tokens ADD COLUMN IF NOT EXISTS last_seen_at BIGINT")
            conn.execute("ALTER TABLE user_tokens ADD COLUMN IF NOT EXISTS revoked_at TEXT")
    ...
    with get_conn() as conn:
        ...
        _ensure_column(conn, "wallet_transactions", "source_type", "TEXT")
        _ensure_column(conn, "wallet_transactions", "source_id", "INTEGER")
        _ensure_column(conn, "wallet_transactions", "source_key", "TEXT")
        conn.execute("CREATE UNIQUE INDEX IF NOT EXISTS idx_wallet_transactions_source_key ON wallet_transactions(source_key)")
        ...
        _ensure_column(conn, "topups", "meta_cap_before", "INTEGER")
        _ensure_column(conn, "topups", "meta_cap_target", "INTEGER")
        _ensure_column(conn, "topups", "meta_cap_confirmed", "INTEGER")
        _ensure_column(conn, "topups", "meta_cap_error", "TEXT")
        _ensure_column(conn, "topups", "meta_cap_attempted_at", "TEXT")
        _ensure_column(conn, "topups", "meta_cap_applied_at", "TEXT")
